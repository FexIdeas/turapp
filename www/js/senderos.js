...
function onPopUpOpen(){
    ...
    var mapTemplate =
            ...
            '                       <span id="sector" class="sectorTitulo"></span>' +
            '                   </div>' +
            '               </div>' +
            '           </li>' +
            '       </ul>' +
            ...
            '<br>' +
            '<div class="card">' +
            '   <div class="card-header tituloSendero headerSenderos">Referencias</div>' +
            ...
            '<br>' +
            '<div class="card">' +
            '   <div class="card-header tituloSendero headerSenderos">Cómo llegar</div>' +
